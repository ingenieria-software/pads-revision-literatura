...
\begin{itemize}
    ...
    \item ¿Qué beneficia o perjudica la enseñanza de nuevas habilidades en programación, pruebas, integración, entrega y qué impacto genera esta enseñanza en aspectos tales como colaboración, generación de mejores hábitos de programación, emprendedurismo e inserción laboral? \ref{sec:objetivo-especifico-3})    
\end{itemize}
